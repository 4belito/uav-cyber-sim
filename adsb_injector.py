...
def remote_id_to_adsb_vehicle(beacon: RemoteIDBeacon, system_id: int = 1, component_id: int = 1):
    """
...
def generate_sample_traffic(center_lat: float, center_lon: float, center_alt: float) -> RemoteIDBeacon:
    """
...
Example setup:
  ...
  param set AVD_ENABLE 1
    ...
    parser.add_argument(
        ...
        type=float,
        default=5.0,
        help="Update rate in Hz (default: 5)"
    )
    ...
    try:
        ...
        while True:
            ...
            print(f"  Sent: {beacon.callsign} @ ({beacon.latitude:.6f}, "
