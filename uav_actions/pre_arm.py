...
from mission_flow import Step, Action, StepFailed  # assuming these are in your core module
...
def check_noarmed(conn,blocking=False):
...
def make_pre_arm_action(conn):
    ...
    check_sys_status_step = Step("Check system",check_fn=check_sys_status)
